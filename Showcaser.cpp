...
void Showcaser::putdigit(int const & x, int const & y, int const & val)
{
...
void Showcaser::putfloat(int const & x, int const & y, std::string const & val)
{
	int i = 0;
	if (val[0] == '-'){
		putdigit(x, y, 11);
...
void Showcaser::square(Event const & e)
{
	SDL_Rect rect;
